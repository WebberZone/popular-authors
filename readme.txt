...
* **pa_authors** or **pa_authors_daily**: Class of the main wrapper `div`

= Shortcodes =

Use `[pa_popular_authors]` to display the popular authors. Optional parameters include `number` to limit the number of authors returned.
